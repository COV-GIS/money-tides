import{iy as A,ab as M,u as at,iX as Ne,iB as le,lx as ee,oC as rt,nH as ce,oD as st,iA as lt,iC as ct,iE as ft,iD as ut,ix as k,mG as dt,eD as _t,hr as vt,oE as ht,af as H,a$ as ge,oF as mt,A as oe,lm as Fe,b as ve,oG as pt,oH as gt,oI as yt,oJ as xt,D as St,H as Tt,ai as It,oK as N,oL as Be,iF as ye,bm as bt,bl as Et,oM as xe,s as Ue,iU as Ot,fX as Se,P as At,oN as Pt}from"./index-BHRLOV7X.js";import{$ as Mt,d as Te,f as Ct,g as Ye,s as z,t as Lt,n as q,e as X,h as Ge}from"./c-Utils-DMg1w2OP.js";import{e as zt,a as te}from"./c-ProgramTemplate-fewXlvTQ.js";import{h as $}from"./c-VertexArrayObject-BXllUg27.js";import{n as Dt}from"./c-VertexAttributeLocations-BfZbt_DV.js";import{t as ne}from"./c-VertexElementDescriptor-BLyltQyJ.js";import{r as j}from"./c-VertexBuffer-Dpx4Yybn.js";import{n as Rt}from"./c-vec3f32-WCVSSNPR.js";import{e as He,n as Vt}from"./c-Container-3nSAT8wa.js";import{n as wt}from"./c-memoryEstimations-CnQAguDA.js";import{o as fe}from"./c-BufferObject-CRTKzWC0.js";import{e as Ie}from"./c-config-BOD8--da.js";import{e as Nt}from"./c-earcut-D9gy186-.js";import{t as Ft,X as Bt}from"./c-featureConversionUtils-CSrdxaKi.js";import{e as be}from"./c-OptimizedFeature-BoF54c6P.js";function ke(){return new Float32Array(4)}function Ut(f){const e=new Float32Array(4);return e[0]=f[0],e[1]=f[1],e[2]=f[2],e[3]=f[3],e}function B(f,e,t,n){const i=new Float32Array(4);return i[0]=f,i[1]=e,i[2]=t,i[3]=n,i}function $e(){return ke()}function We(){return B(1,1,1,1)}function Ze(){return B(1,0,0,0)}function je(){return B(0,1,0,0)}function Ke(){return B(0,0,1,0)}function Xe(){return B(0,0,0,1)}const Yt=$e(),Gt=We(),Ht=Ze(),kt=je(),$t=Ke(),Wt=Xe();Object.freeze(Object.defineProperty({__proto__:null,ONES:Gt,UNIT_W:Wt,UNIT_X:Ht,UNIT_Y:kt,UNIT_Z:$t,ZEROS:Yt,clone:Ut,create:ke,fromValues:B,ones:We,unitW:Xe,unitX:Ze,unitY:je,unitZ:Ke,zeros:$e},Symbol.toStringTag,{value:"Module"}));let U=class{constructor(){this.name=this.constructor.name||"UnnamedBrush",this.brushEffect=null}prepareState(e,t){}draw(e,t,n){}drawMany(e,t,n){for(const i of t)i.visible&&this.draw(e,i,n)}};const Zt={background:{"background.frag":`uniform lowp vec4 u_color;
void main() {
