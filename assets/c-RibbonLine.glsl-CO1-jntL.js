import{dD as O,hP as Ye,hI as it,ez as me,ep as It,eB as K,eE as Qe,hG as kt,hF as He,dK as Ge,qM as Ut,eD as ee,dT as De,ea as Nt,dR as ae,e5 as Bt,hk as Ht,ah as Gt,gG as at,A as Jt,ey as qt,mz as Xt,_ as Yt,iG as st,v as P,cp as We,b as Tt,kg as Qt,qV as le,dC as ve,dJ as nt,dU as Ve,dE as Zt,ol as Kt,dP as Je,aO as ei,X as ti}from"./index-vefUvhIm.js";import{a as ii,n as Ze,s as ai,r as si}from"./c-vec4f64-DPb6J-GU.js";import{t as ni}from"./c-orientedBoundingBox-BmqUGhhj.js";import{aY as ri,aZ as oi,a_ as li,r as q,aG as ci,aL as di,ax as $t,a$ as pi,c as he,b0 as rt,G as hi,a6 as Ke,aI as et,b as ui,L as Ce,ar as fi,H as mi,K as vi,D as gi,b1 as Si,ao as bi,aq as yi,I as _i,J as xi,M as Ti,a2 as ce,a as Pt,j as $i,k as Pi,b2 as zi,O as ot,P as wi,Q as lt,R as Te,T as Oi,U as Di,V as Ci,W as Ai,X as fe,b3 as Ri,b4 as ct,b5 as Ei,b6 as Li,b7 as dt,Y as Wi,x as z,A as Vi,b8 as Fi,$ as Mi,b9 as pt,a0 as ji,a4 as Ii,a5 as ki,ba as ht,m as Ui}from"./c-OutputColorHighlightOID.glsl-LgeFWw1-.js";import{N as Ni,I as Bi,P as Hi}from"./c-sphere-CMaGuPDf.js";import{m as Gi,w as $e,j as Ae,X as Q,k as ut}from"./c-plane-QunV0I2Y.js";import{s as Ji,n as qi,t as Xi}from"./c-BufferView-D7g1XhZ1.js";import{S as Yi}from"./c-Octree-UJur267f.js";import{s as ge}from"./c-vec42-CVeWdqn5.js";import{M as Qi,b as Fe,v as zt,B as Zi}from"./c-lineSegment-DhrPGt2p.js";import{Q as Ki}from"./c-InterleavedLayout-DiLR1Sof.js";import{T as Pe,d as Me,r as ft}from"./c-renderState-CKc66y4x.js";import{f as ea}from"./c-computeTranslationToOriginAndRotation-CBISP3qa.js";import{t as wt}from"./c-HUDMaterial.glsl-Cz6Xi2Zb.js";import{n as ta,e as ia}from"./c-ElevationInfo-BW_nstwu.js";import{u as aa}from"./c-hydratedFeatures-BUsdjG7c.js";import{t as c,n as j}from"./c-glsl-B5bJgrnA.js";import"./c-lengthUtils-DeJO1qar.js";import{s as sa}from"./c-ShaderBuilder-BdoCThjR.js";function na(a){return a==="position"}function ra(a,e){return a==null&&(a=[]),a.push(e),a}function oa(a,e){if(a==null)return null;const t=a.filter(i=>i!==e);return t.length===0?null:t}function _s(a,e,t,i,s){ze[0]=a.get(e,0),ze[1]=a.get(e,1),ze[2]=a.get(e,2),ri(ze,re,3),t.set(s,0,re[0]),i.set(s,0,re[1]),t.set(s,1,re[2]),i.set(s,1,re[3]),t.set(s,2,re[4]),i.set(s,2,re[5])}const ze=O(),re=new Float32Array(6);let la=class{constructor(e={}){this.id=Ye(),this._highlightIds=new Set,this._shaderTransformation=null,this._visible=!0,this.castShadow=e.castShadow??!0,this.usesVerticalDistanceToGround=e.usesVerticalDistanceToGround??!1,this.graphicUid=e.graphicUid,this.layerViewUid=e.layerViewUid,e.isElevationSource&&(this.lastValidElevationBB=new Ot),this._geometries=e.geometries?Array.from(e.geometries):new Array}dispose(){this._geometries.length=0}get layer(){return this._layer}set layer(e){Ji(this._layer==null||e==null,"Object3D can only be added to a single Layer"),this._layer=e}addGeometry(e){e.visible=this._visible,this._geometries.push(e);for(const t of this._highlightIds)e.addHighlight(t);this._emit("geometryAdded",{object:this,geometry:e}),this._highlightIds.size&&this._emit("highlightChanged",this),this._invalidateBoundingVolume()}removeGeometry(e){const t=this._geometries.splice(e,1)[0];if(t){for(const i of this._highlightIds)t.removeHighlight(i);this._emit("geometryRemoved",{object:this,geometry:t}),this._highlightIds.size&&this._emit("highlightChanged",this),this._invalidateBoundingVolume()}}removeAllGeometries(){for(;this._geometries.length>0;)this.removeGeometry(0)}geometryVertexAttributeUpdated(e,t,i=!1){this._emit("attributesChanged",{object:this,geometry:e,attribute:t,sync:i}),na(t)&&this._invalidateBoundingVolume()}get visible(){return this._visible}set visible(e){if(this._visible!==e){this._visible=e;for(const t of this._geometries)t.visible=this._visible;this._emit("visibilityChanged",this)}}maskOccludee(){const e=new oi;for(const t of this._geometries)t.occludees=ra(t.occludees,e);return this._emit("occlusionChanged",this),e}removeOcclude(e){for(const t of this._geometries)t.occludees=oa(t.occludees,e);this._emit("occlusionChanged",this)}highlight(e){const t=new li(e);for(const i of this._geometries)i.addHighlight(t);return this._emit("highlightChanged",this),this._highlightIds.add(t),t}removeHighlight(e){this._highlightIds.delete(e);for(const t of this._geometries)t.removeHighlight(e);this._emit("highlightChanged",this)}removeStateID(e){e.channel===0?this.removeHighlight(e):this.removeOcclude(e)}getCombinedStaticTransformation(e,t){return it(t,this.transformation,e.transformation)}getCombinedShaderTransformation(e,t=me()){return it(t,this.effectiveTransformation,e.transformation)}get boundingVolumeWorldSpace(){return this._bvWorldSpace||(this._bvWorldSpace=this._bvWorldSpace||new mt,this._validateBoundingVolume(this._bvWorldSpace,0)),this._bvWorldSpace}get boundingVolumeObjectSpace(){return this._bvObjectSpace||(this._bvObjectSpace=this._bvObjectSpace||new mt,this._validateBoundingVolume(this._bvObjectSpace,1)),this._bvObjectSpace}_validateBoundingVolume(e,t){const i=t===1;for(const s of this._geometries){const n=s.boundingInfo;n&&ca(n,e,i?s.transformation:this.getCombinedShaderTransformation(s))}Ni(e.bounds,It(je,e.min,e.max,.5));for(const s of this._geometries){const n=s.boundingInfo;if(n==null)continue;const o=i?s.transformation:this.getCombinedShaderTransformation(s),l=Gi(o);K(je,n.center,o);const r=Qe(je,Bi(e.bounds)),d=n.radius*l;e.bounds[3]=Math.max(e.bounds[3],r+d)}}_invalidateBoundingVolume(){const e=this._bvWorldSpace?.bounds;this._bvObjectSpace=this._bvWorldSpace=void 0,this.layer&&e&&this.layer.notifyObjectBBChanged(this,e)}_emit(e,t){this.layer?.events.emit(e,t)}get geometries(){return this._geometries}get transformation(){return this._transformation??kt}set transformation(e){this._transformation=He(this._transformation??me(),e),this._invalidateBoundingVolume(),this._emit("transformationChanged",this)}get shaderTransformation(){return this._shaderTransformation}set shaderTransformation(e){this._shaderTransformation=e?He(this._shaderTransformation??me(),e):null,this._invalidateBoundingVolume(),this._emit("shaderTransformationChanged",this)}get effectiveTransformation(){return this.shaderTransformation??this.transformation}get test(){}},Ot=class{constructor(){this._data=[Number.MAX_VALUE,Number.MAX_VALUE,Number.MAX_VALUE,-Number.MAX_VALUE,-Number.MAX_VALUE,-Number.MAX_VALUE]}get min(){return Ge(this._data[0],this._data[1],this._data[2])}get max(){return Ge(this._data[3],this._data[4],this._data[5])}minWith(e){const{_data:t}=this;t[0]=Math.min(t[0],e[0]),t[1]=Math.min(t[1],e[1]),t[2]=Math.min(t[2],e[2])}maxWith(e){const{_data:t}=this;t[3]=Math.max(t[3],e[0]),t[4]=Math.max(t[4],e[1]),t[5]=Math.max(t[5],e[2])}assignMinMax(e,t){for(let i=0;i<3;++i)this._data[0+i]=e[i],this._data[3+i]=t[i]}isEmpty(){return this._data[3]<this._data[0]&&this._data[4]<this._data[1]&&this._data[5]<this._data[2]}};class mt extends Ot{constructor(){super(...arguments),this.bounds=Hi()}}function ca(a,e,t){const i=a.bbMin,s=a.bbMax;if(Ut(t)){const n=ee(da,t[12],t[13],t[14]);return De(N,i,n),De(J,s,n),e.minWith(N),void e.maxWith(J)}if(K(N,i,t),Nt(i,s))return e.minWith(N),void e.maxWith(N);K(J,s,t),e.minWith(N),e.minWith(J),e.maxWith(N),e.maxWith(J);for(let n=0;n<3;++n)ae(N,i),ae(J,s),N[n]=s[n],J[n]=i[n],K(N,N,t),K(J,J,t),e.minWith(N),e.minWith(J),e.maxWith(N),e.maxWith(J)}const da=O(),N=O(),J=O(),je=O(),pa=["layerObjectAdded","layerObjectRemoved","layerObjectsAdded","layerObjectsRemoved","transformationChanged","shaderTransformationChanged","visibilityChanged","occlusionChanged","highlightChanged","geometryAdded","geometryRemoved","attributesChanged"];let ha=class{constructor(e,t,i=""){this.stage=e,this.apiLayerViewUid=i,this.id=Ye(),this.events=new Bt,this.visible=!0,this.sliceable=!1,this._objectsAdded=new Array,this._handles=new Ht,this._objects=new Map,this._pickable=!0,this.visible=t?.visible??!0,this._pickable=t?.pickable??!0,this.updatePolicy=t?.updatePolicy??0,e.addLayer(this);for(const s of pa)this._handles.add(this.events.on(s,n=>e.handleEvent(s,n)))}destroy(){this._handles.size&&(this._handles.destroy(),this.stage.removeLayer(this),this.invalidateSpatialQueryAccelerator())}get objects(){return this._objects}getObject(e){return Gt(this._objects.get(e))}set pickable(e){this._pickable=e}get pickable(){return this._pickable&&this.visible}add(e){this._objects.set(e.id,e),e.layer=this,this.events.emit("layerObjectAdded",e),this._octree!=null&&this._objectsAdded.push(e)}remove(e){this._objects.delete(e.id)&&(this.events.emit("layerObjectRemoved",e),e.layer=null,this._octree!=null&&(at(this._objectsAdded,e)||this._octree.remove([e])))}addMany(e){for(const t of e)this._objects.set(t.id,t),t.layer=this;this.events.emit("layerObjectsAdded",e),this._octree!=null&&this._objectsAdded.push(...e)}removeMany(e){const t=new Array;for(const i of e)this._objects.delete(i.id)&&t.push(i);if(t.length!==0&&(this.events.emit("layerObjectsRemoved",t),t.forEach(i=>i.layer=null),this._octree!=null)){for(let i=0;i<t.length;)at(this._objectsAdded,t[i])?(t[i]=t[t.length-1],t.length-=1):++i;this._octree.remove(t)}}commit(){this.stage.commitLayer(this)}sync(){this.updatePolicy!==1&&this.stage.syncLayer(this.id)}notifyObjectBBChanged(e,t){this._octree==null||this._objectsAdded.includes(e)||this._octree.update(e,t)}getSpatialQueryAccelerator(){return this._octree==null&&this._objects.size>50?(this._octree=new Yi(e=>e.boundingVolumeWorldSpace.bounds),this._octree.add(this._objects.values())):this._octree!=null&&this._objectsAdded.length>0&&(this._octree.add(this._objectsAdded),this._objectsAdded.length=0),this._octree}invalidateSpatialQueryAccelerator(){this._octree=Jt(this._octree),this._objectsAdded.length=0}get test(){}},ua=class{constructor(e,t){this.vec3=e,this.id=t}};function vt(a,e,t,i){return new ua(Ge(a,e,t),i)}const gt=8;function fa(a,e){const{vertex:t,attributes:i}=a;t.uniforms.add(new q("intrinsicWidth",o=>o.width));const{hasScreenSizePerspective:s,spherical:n}=e;s?(a.include(ci,e),di(t),$t(t,e),t.uniforms.add(new pi("inverseViewMatrix",(o,l)=>qt(St,Xt(St,l.camera.viewMatrix,o.origin)))),t.code.add(c`
...
return color;
}`),e.hasVVColor?(a.include(hi,e),i.add("colorFeatureAttribute","float"),t.code.add(c`vec4 getColor() {
...
return applyOpacity(color);
}`))}const St=me();function ma(a){a.vertex.code.add("#define noPerspectiveWrite(x, w) (x * w)")}function qe(a){a.fragment.code.add("#define noPerspectiveRead(x) (x * gl_FragCoord.w)")}function va(a){return a.pattern.map(e=>Math.round(e*a.pixelRatio))}function ga(a){if(a==null)return 1;const e=va(a);return Math.floor(e.reduce((t,i)=>t+i))}function Sa(a){return a==null?ii:a.length===4?a:ge(ba,a[0],a[1],a[2],1)}const ba=Ze();function ya(a,e){if(!e.stippleEnabled)return void a.fragment.code.add(c`float getStippleAlpha(float lineWidth) { return 1.0; }
...
return worldToScreenPerDistanceRatio / segmentDistanceToCamera;
  ...
  `),s.uniforms.add(new ui("stipplePatternTexture",n=>n.stippleTexture),new q("stipplePatternPixelSizeInv",n=>1/Dt(n))),e.stippleOffColorEnabled&&s.uniforms.add(new Ce("stippleOffColor",n=>Sa(n.stippleOffColor))),a.include(qe),s.code.add(c`float getStippleSDF(out bool isClamped) {
...
return isClamped ? floor(antiAliasedResult + 0.5) : antiAliasedResult;
  ...
  `)}function Dt(a){const e=a.stipplePattern;return e?ga(a.stipplePattern)/e.pixelRatio:1}const _a=.4,Ct=64,xa=Ct/2,Ta=xa/5,$a=Ct/Ta,zs=.25;function Pa(a,e){const t=a.vertex,i=e.hasScreenSizePerspective;et(t),t.uniforms.get("markerScale")==null&&t.constants.add("markerScale","float",1),t.constants.add("markerSizePerLineWidth","float",$a).code.add(c`
  ...
  `))}function za(a,e){if(!e.hasAnimation)return;const{attributes:t,varyings:i,vertex:s,fragment:n}=a;t.add("timeStamps","vec4"),i.add("vTimeStamp","float"),i.add("vFirstTime","float"),i.add("vLastTime","float"),i.add("vTransitionType","float"),s.main.add(c`vTimeStamp = timeStamps.x;
vFirstTime = timeStamps.y;
vLastTime = timeStamps.z;
vTransitionType = timeStamps.w;`);const{animation:o}=e;o===3&&n.constants.add("decayRate","float",2.3),n.code.add(c`
    float getTrailOpacity(float x) {
      ${wa(o)}
    }`),n.uniforms.add(new q("timeElapsed",l=>l.timeElapsed),new q("trailLength",l=>l.trailLength),new q("speed",l=>l.animationSpeed),new Ce("timingOptions",l=>ge(Oa,l.startTime,l.endTime,l.fadeInTime,l.fadeOutTime))),n.code.add(c`float fadeIn(float x) {
...
return animatedColor;
        ...
        return (exp(-decayRate * x) - cutOff) / (1.0 - cutOff);`;default:return"return 1.0;"}}const Oa=Ze(),Se=1;function At(a){const e=new sa,{attributes:t,varyings:i,vertex:s,fragment:n}=e,{applyMarkerOffset:o,draped:l,output:r,capType:d,stippleEnabled:p,falloffEnabled:g,roundJoins:m,wireframe:u,innerColorEnabled:f,hasAnimation:y,hasScreenSizePerspective:b}=a;n.include(fi),e.include(fa,a),e.include(ya,a),e.include(mi,a),e.include(vi,a),e.include(za,a);const G=o&&!l;G&&(s.uniforms.add(new q("markerScale",v=>v.markerScale)),e.include(Pa,{space:2,hasScreenSizePerspective:b})),gi(s,a),s.uniforms.add(new Si("inverseProjectionMatrix",v=>v.camera.inverseProjectionMatrix),new bi("nearFar",v=>v.camera.nearFar),new q("miterLimit",v=>v.join!=="miter"?0:v.miterLimit),new yi("viewport",v=>v.camera.fullViewport)),s.constants.add("LARGE_HALF_FLOAT","float",65500),t.add("position","vec3"),t.add("previousDelta","vec4"),t.add("nextDelta","vec4"),t.add("lineParameters","vec2"),t.add("u0","float"),i.add("vColor","vec4"),i.add("vpos","vec3",{invariant:!0}),i.add("vLineDistance","float"),i.add("vLineWidth","float");const X=p;X&&i.add("vLineSizeInv","float");const h=d===2,A=p&&h,R=g||A;R&&i.add("vLineDistanceNorm","float"),h&&(i.add("vSegmentSDF","float"),i.add("vReverseSegmentSDF","float")),s.code.add(c`vec2 perpendicular(vec2 v) {
return vec2(v.y, -v.x);
}
...
vec2(vStippleDistanceLimits.x, 1e34);`)),s.main.add(c`
    ...
    }`),e.fragment.include(_i,a),e.include(xi,a),n.include(Ti),n.main.add(c`discardBySlice(vpos);
