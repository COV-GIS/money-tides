const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/money-tides-RealisticTree.glsl-C4lEUb8t.js","assets/money-tides-jsxFactory-DhEmlXtp.js","assets/index-DssDhHvH.js","assets/index-BU23byjB.css","assets/money-tides-runtime-BAFbAsol.js","assets/runtime-OCMtRbrJ.css","assets/money-tides-HUDMaterial.glsl-DITdF-ry.js","assets/money-tides-app-config-oTxpbYta.js","assets/money-tides-ReactiveMap-Dlq5faT3.js","assets/money-tides-messageBundle-DPd1O8PX.js","assets/money-tides-index-BSQMl5Dg.js","assets/money-tides-meshVertexSpaceUtils-CD9KoVJu.js","assets/money-tides-MeshLocalVertexSpace-DpyAA2Dw.js","assets/money-tides-projectVectorToVector-g_TEPFPe.js","assets/money-tides-projectPointToVector-YzaI9wBM.js","assets/money-tides-hydratedFeatures-BArsIouA.js","assets/money-tides-vec3f32-WCVSSNPR.js","assets/money-tides-OutputColorHighlightOID.glsl-uJtG2ouL.js","assets/money-tides-Indices-DjkN6tuC.js","assets/money-tides-BufferView-DmihqMHg.js","assets/money-tides-triangle-CTR18ibV.js","assets/money-tides-sphere-8ijv-Uvr.js","assets/money-tides-vectorStacks-Dc30QAsv.js","assets/money-tides-quatf64-aQ5IuZRd.js","assets/money-tides-lineSegment-CS0ZQrlB.js","assets/money-tides-renderState-CKc66y4x.js","assets/money-tides-glsl-B5bJgrnA.js","assets/money-tides-frustum-Bqyid0V5.js","assets/money-tides-plane-5w0qxiP8.js","assets/money-tides-orientedBoundingBox-T_1FaKoT.js","assets/money-tides-quat-D-ccV1cq.js","assets/money-tides-spatialReferenceEllipsoidUtils-CHBzRuwh.js","assets/money-tides-computeTranslationToOriginAndRotation-DpQQlwFl.js","assets/money-tides-VertexAttributeLocations-BfZbt_DV.js","assets/money-tides-VertexElementDescriptor-BLyltQyJ.js","assets/money-tides-InterleavedLayout-jsXg9ecV.js","assets/money-tides-types-BKo2foNY.js","assets/money-tides-ShaderBuilder-DyjGwxeJ.js"])))=>i.map(i=>d[i]);
import{j as x,ac as k,v as ze,h0 as et,fR as At,dj as V,fH as Dt,la as Gt,gQ as jt,h4 as Q,H as tt,h3 as $e,fP as Ge,fF as Bt,iv as Ht,pj as U,e0 as at,gR as ne,c1 as Wt,c3 as kt,gu as Ut,bF as Yt,a3 as z,cJ as qt,aP as Zt,ae as Xt,p as Jt,a2 as Kt,co as be,cp as Qt,cu as je,Y as ea,fD as ta}from"./money-tides-app-config-oTxpbYta.js";import{a6 as E,i as he,d as me,a7 as I,a as ot,a8 as pe,a9 as rt,aa as it,ab as aa,ac as W,ad as oa,ae as ra,af as ia,f as na,ag as J,r as O,a2 as ae,D as A,E as D,ah as G,G as K,b as y,I as j,ai as sa,H as la,aj as ca,ak as nt,q as se,al as st,o as lt,am as ct,g as da,j as Fe,k as fe,s as dt,an as ua,ao as ha,u as ma,v as Be,ap as pa,aq as _,ar as Ne,as as fa,at as va,c as ee,au as ga,W as oe,av as xa,M as ba,aw as ut,ax as le,F as ht,L as mt,K as pt,ay as ft,J as vt,N as wa,O as ya,P as Ma,Q as Ta,R as _a,T as Sa,U as Ca,V as za,X as $a,Y as Fa,x as m,A as Na,az as we,aA as ye,a1 as Oa,aB as Ia,B as La,aC as Va,a3 as Ea,aD as Ra}from"./money-tides-OutputColorHighlightOID.glsl-uJtG2ouL.js";import{_ as ve}from"./index-DssDhHvH.js";import{t as Ce,Q as Oe}from"./money-tides-InterleavedLayout-jsXg9ecV.js";import{bg as Ie,a_ as Pa,aB as Aa,d7 as gt,_ as c,m as H,f as xt,d8 as Da,d9 as Ga,L as re,af as ja,x as Ba}from"./money-tides-jsxFactory-DhEmlXtp.js";import{t as i,n as p}from"./money-tides-glsl-B5bJgrnA.js";import{s as S,T as bt,g as ce,I as He}from"./money-tides-BufferView-DmihqMHg.js";import{r as Ha}from"./money-tides-VertexBuffer-DOgApKOq.js";import{g as Wa}from"./money-tides-plane-5w0qxiP8.js";import{s as ge}from"./money-tides-ShaderBuilder-DyjGwxeJ.js";import{T as Le,d as Ve,_ as ka}from"./money-tides-renderState-CKc66y4x.js";import{t as Ua}from"./money-tides-VertexAttributeLocations-BfZbt_DV.js";function xe(a,e){switch(a.fragment.code.add(i`vec3 screenDerivativeNormal(vec3 positionView) {
...
return color;
}`)}const Ue=k();function _t(a,e){const{hasModelTransformation:t,instancedDoublePrecision:o,instanced:r,output:s,hasVertexTangents:d}=e;t&&(a.vertex.uniforms.add(new aa("model",l=>l.modelTransformation??Ge)),a.vertex.uniforms.add(new I("normalLocalOriginFromModel",l=>(Bt(Ue,l.modelTransformation??Ge),Ue)))),r&&o&&(a.attributes.add("instanceModelOriginHi","vec3"),a.attributes.add("instanceModelOriginLo","vec3"),a.attributes.add("instanceModel","mat3"),a.attributes.add("instanceModelNormal","mat3"));const n=a.vertex;o&&(n.include(Ya,e),n.uniforms.add(new W("viewOriginHi",l=>oa(V(ie,l.camera.viewInverseTransposeMatrix[3],l.camera.viewInverseTransposeMatrix[7],l.camera.viewInverseTransposeMatrix[11]),ie)),new W("viewOriginLo",l=>ra(V(ie,l.camera.viewInverseTransposeMatrix[3],l.camera.viewInverseTransposeMatrix[7],l.camera.viewInverseTransposeMatrix[11]),ie)))),n.code.add(i`
...
}`),s&&d!==0&&(a.include(nt,e),t.uniforms.add(n===1?new y("normalTexture",u=>u.textureNormal):new se("normalTexture",u=>u.textureNormal)),l&&(t.uniforms.add(new st("scale",u=>u.scale??Ht)),t.uniforms.add(new I("normalTextureTransformMatrix",u=>u.normalTextureTransformMatrix??U))),t.code.add(i`vec3 computeTextureNormal(mat3 tangentSpace, vec2 uv) {
...
}`))}function Rr(a,e){a.include(Ne),a.code.add(i`
...
return clamp((x * (2.51 * x + 0.03)) / (x * (2.43 * x + 0.59) + 0.14), 0.0, 1.0);
    ...
    const float GAMMA_SRGB = ${i.float(qt)};
...
}`);break;default:Ie(e.doubleSidedMode);case 3:}}function $t(a,e){const t=e.pbrMode,o=a.fragment;if(t!==2&&t!==0&&t!==1)return void o.code.add(i`void applyPBRFactors() {}`);if(t===0)return void o.code.add(i`void applyPBRFactors() {}
...
}`)):a.vertex.code.add(i`void forwardMetallicRoughnessUV(){}`)}function Lt(a){a.include(ba),a.code.add(i`
