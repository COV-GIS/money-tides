import{jk as A,bo as M,a0 as at,jK as Ne,jn as le,nr as ee,s3 as rt,qM as ce,s4 as st,jm as lt,jo as ct,jq as ft,jp as ut,jj as k,pA as dt,eK as _t,hZ as vt,nE as ht,s5 as mt,L as H,bf as ge,s6 as pt,cO as oe,ni as Fe,j as ve,s7 as gt,s8 as yt,s9 as xt,sa as St,d4 as Tt,d6 as It,bv as bt,sb as N,sc as Be,js as ye,c6 as Et,c5 as Ot,sd as xe,b5 as Se,s as Ue,jH as At,g8 as Te,dm as Pt,se as Mt}from"./index-8Q_kpVyM.js";import{$ as Ct,d as Ie,f as Lt,g as Ye,s as z,t as zt,n as X,e as q,h as Ge}from"./c-Utils-C5MPDqOu.js";import{e as Dt,a as te}from"./c-ProgramTemplate-BVoZpFfP.js";import{h as $}from"./c-VertexArrayObject-DQ9A5DSN.js";import{n as Rt}from"./c-VertexAttributeLocations-BfZbt_DV.js";import{t as ne}from"./c-VertexElementDescriptor-BLyltQyJ.js";import{r as j}from"./c-VertexBuffer-BtZbIkMa.js";import{n as Vt}from"./c-vec3f32-WCVSSNPR.js";import{e as He,n as wt}from"./c-Container-CjzO2Kl-.js";import{o as fe}from"./c-BufferObject-BfrnEf60.js";import{e as be}from"./c-config-BOD8--da.js";import{e as Nt}from"./c-earcut-D9gy186-.js";import{t as Ft,X as Bt}from"./c-featureConversionUtils-8wPxUK9v.js";function ke(){return new Float32Array(4)}function Ut(f){const e=new Float32Array(4);return e[0]=f[0],e[1]=f[1],e[2]=f[2],e[3]=f[3],e}function B(f,e,t,n){const i=new Float32Array(4);return i[0]=f,i[1]=e,i[2]=t,i[3]=n,i}function $e(){return ke()}function We(){return B(1,1,1,1)}function Ze(){return B(1,0,0,0)}function je(){return B(0,1,0,0)}function Ke(){return B(0,0,1,0)}function qe(){return B(0,0,0,1)}const Yt=$e(),Gt=We(),Ht=Ze(),kt=je(),$t=Ke(),Wt=qe();Object.freeze(Object.defineProperty({__proto__:null,ONES:Gt,UNIT_W:Wt,UNIT_X:Ht,UNIT_Y:kt,UNIT_Z:$t,ZEROS:Yt,clone:Ut,create:ke,fromValues:B,ones:We,unitW:qe,unitX:Ze,unitY:je,unitZ:Ke,zeros:$e},Symbol.toStringTag,{value:"Module"}));let U=class{constructor(){this.name=this.constructor.name||"UnnamedBrush",this.brushEffect=null}prepareState(e,t){}draw(e,t,n){}drawMany(e,t,n){for(const i of t)i.visible&&this.draw(e,i,n)}};const Zt={background:{"background.frag":`uniform lowp vec4 u_color;
void main() {
