...
@subclass('TrafficAccidentsLayer')
export default class TrafficAccidentsLayer extends GraphicsLayer {
  ...
  @property()
  override title = 'Traffic Accidents';

  @property()
  override visible = false;

  private async fetchData(): Promise<Response> {
    return await (await fetch('https://www.vernonia-or.gov/road-data/accidents/')).json();
  }
