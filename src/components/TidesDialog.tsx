...
const CSS = {
  tableTimeCell: `${CSS_BASE}_table-time-cell`,
};
...
export default class TidesDialog extends Widget {
  ...
  render(): tsx.JSX.Element {
    ...
    return (
      <calcite-dialog class={CSS_BASE} heading={heading} placement="bottom-start" scale="s" width="s">
        {/* header menu actions */}
        <calcite-action
          icon="brightness"
          scale="s"
          slot="header-menu-actions"
          text={showSunAndMoon ? 'Hide Sun and Moon' : 'Show Sun and Moon'}
          text-enabled=""
          onclick={(): void => {
        ...
        <calcite-table hidden={content !== 'tides'} striped scale="s" style="--calcite-table-border-color: none;">
          <calcite-table-row slot="table-header">
            ...
            <calcite-table-header heading="Event"></calcite-table-header>
            <calcite-table-header heading="Height"></calcite-table-header>
            {showSunAndMoon
              ? [
                  <calcite-table-header heading="Sun" key={KEY++}></calcite-table-header>,
                  <calcite-table-header heading="Moon" key={KEY++}></calcite-table-header>,
                ]
              : null}
          </calcite-table-row>
          {tides
            ...
            .map((tide: MT.Tide): tsx.JSX.Element => {
              ...
              console.log(sunPosition, moonPosition);
