...
export default class MoneyTides extends Widget {
  ...
  private async updateStation(station: MT.Station): Promise<void> {
    ...
    try {
      ...
      if (this.tidesDialog.container.open && this.tidesDialog.station.id === id) {
        this.tidesDialog.open(station);
      }
  ...
  override render(): tsx.JSX.Element {
    ...
    return (
      <calcite-shell class={CSS_BASE} content-behind="">
        ...
        <calcite-dialog
          slot="dialogs"
          afterCreate={async (container: HTMLCalciteDialogElement): Promise<void> => {
