...
// Attribution and Zoom are required b/c the api loads them and will error without assets
...
(async () => {
  try {
     ...
     * calcite
     *
     * Danger: This writes over the calcite assets provided by @argis/core with the most up-to-date @esri/calcite-components assets.
     */
